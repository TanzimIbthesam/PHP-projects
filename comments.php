  ...
  <body>
    <!-- header -->
      ...
      <header class="bg-dark text-white py-3">
        ...
        <table style="min-width:140px;" class="table table-striped table-hover"> 
        ...
        <td><a style="min-width:140px;" class="btn btn-primary" href="fullpost.php?id=<?php echo $commentpostid; ?>"target=_blank>Live Preview</a></td>
        </tr>
        </tbody>
        <?php }?>
        </table>
