...
if (isset($_POST['Submit'])) {
    ...
    if(empty($posttitle)){
        $_SESSION['ErrorMessage']="Title Must not be empty";
        // redirect_to("editpost.php?id=<?php echo $searchqueryparam; //?/>");
        redirect_to("posts.php");
    }elseif(strlen($posttitle)<5){
        $_SESSION['ErrorMessage']="Post title must be greater than 5 characters";
        redirect_to("posts.php");
      }elseif(strlen($posttext)>9999){
        $_SESSION['ErrorMessage']="Post description must not be more than 9999 characters";
        redirect_to("posts.php");
    }else{ 
        //Post to be Updated
    global $conn;
      ...
      <header class="bg-dark text-white py-3">
       ...
       <section class="container py-2">
           <div class="row">
            ...
            <!-- Fetching existing content according to our need -->
             <?php echo ErrorMessage(); 
              ...
              ?>
               <form action="editpost.php?id=<?php echo $searchqueryparam; ?>"method="post"enctype="multipart/form-data">
                   <div class="card bg-secondary text-light">
                       ...
                       <div class="card-body bg-dark">
                           <div class="form-group">
                               ...
                               id="title"placeholder="Type title here"value="<?php echo $titletobeupdated; ?>">
                           </div>
                           <div class="form-group">
                           ...
                           <span class="fieldinfo">Existing image:</span>
                               <img class="mb-2" src="uploads/<?php echo $imagetobeupdated;?>"style="width:100px;height:70px;">
                           ...
                           <textarea class="form-control" name="postdescription" id="post" cols="80" rows="8"value=""><?php echo $posttobeupdated; ?></textarea>
                           </div>
                           <div class="row">
                           ...
                           <div class="col-lg-6 mb-2">
                               <button type="submit" class="form-control btn btn-danger"name="Submit"><i class="fas fa-check"></i>Edit</button>
                           </div>
                           </div>
                       </div>
                   </div>
